...
class PassphrasesViewTest(tests.APITestCase):
    ...
    def test_index(self):
        ...
        api_castellan.list.assert_called_with(mock.ANY, object_type=passphrase.Passphrase)
    ...
    def test_detail_view(self):
        ...
        self.assertContains(
            res, "<dt>Name</dt>\n    <dd>%s</dd>" % self.passphrase.name, 1, 200)
    ...
    def test_import_cert(self):
        ...
        self.mock_object(
            api_castellan, "import_object", mock.Mock(return_value=self.passphrase))
