...
(function() {
  ...
  /**
   * @ngdoc workflow
   * @name horizon.dashboard.key_manager.managed_objects.workflow
   * @description Service for the create/update workflow
   */
  angular
    .module('horizon.dashboard.key_manager.managed_objects')
    .factory('horizon.dashboard.key_manager.managed_objects.workflow', workflow);
          ...
          "tabs": [
            {
              ...
              "help": basePath + "managed_objects/workflow/info.help.html",
              "items": [
                {
                  "key": "name",
            ...
            },
            {
              ...
              "help": basePath + "managed_objects/workflow/recipe.help.html",
              "items": [
                {
                  "key": "size",
                  "type": "radiobuttons",
