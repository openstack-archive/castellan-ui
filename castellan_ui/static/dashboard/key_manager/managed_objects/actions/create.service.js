...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.key_manager.managed_objects.create.service
   * @description Service for the managed_object create modal
   */
  angular
    .module('horizon.dashboard.key_manager.managed_objects')
    .factory('horizon.dashboard.key_manager.managed_objects.create.service', createService);
  ...
  function createService(
    ...
    var message = {
      success: gettext('ManagedObject %s was successfully created.')
    };
    ...
    function perform(selected, newScope) {
      ...
      title = gettext("Create ManagedObject");
    ...
    function allowed() {
      ...
      //return policy.ifAllowed({ rules: [['managed_object', 'create_managed_object']] });
    }

    function submit() {
      model.cleanProperties();
      return api.createManagedObject(model.spec).then(success);
    }
