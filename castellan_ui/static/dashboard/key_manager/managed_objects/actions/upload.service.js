...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.key_manager.managed_objects.upload.service
   * @description Service for the managed_object upload modal
   */
  angular
    .module('horizon.dashboard.key_manager.managed_objects')
    .factory('horizon.dashboard.key_manager.managed_objects.upload.service', uploadService);
  ...
  function uploadService(
    ...
    var message = {
      success: gettext('Managed Object %s was successfully uploaded.')
    };
    ...
    function allowed() {
      ...
      //return policy.ifAllowed({ rules: [['managed_object', 'upload_managed_object']] });
    }
