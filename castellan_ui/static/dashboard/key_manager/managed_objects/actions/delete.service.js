...
(function() {
  ...
  /**
   * @ngDoc factory
   * @name horizon.dashboard.key_manager.managed_objects.delete.service
   * @Description
   * Brings up the delete managed_objects confirmation modal dialog.
   * On submit, delete selected resources.
   * On cancel, do nothing.
   */
  angular
    .module('horizon.dashboard.key_manager.managed_objects')
    .factory('horizon.dashboard.key_manager.managed_objects.delete.service', deleteService);
  ...
  function deleteService(
    ...
    var notAllowedMessage =
      gettext("You are not allowed to delete managed_objects: %s");
    ...
    function allowed() {
      ...
      //return policy.ifAllowed({ rules: [['managed_object', 'delete_managed_object']] });
    }
    ...
    function labelize(count) {
      return {
        title: ngettext('Confirm Delete ManagedObject',
                        'Confirm Delete ManagedObjects', count),
        /* eslint-disable max-len */
        message: ngettext('You have selected "%s". Please confirm your selection. Deleted managed_object is not recoverable.',
                          'You have selected "%s". Please confirm your selection. Deleted managed_objects are not recoverable.', count),
        /* eslint-enable max-len */
        submit: ngettext('Delete ManagedObject',
                         'Delete ManagedObjects', count),
        success: ngettext('Deleted ManagedObject: %s.',
                          'Deleted ManagedObjects: %s.', count),
        error: ngettext('Unable to delete ManagedObject: %s.',
                        'Unable to delete ManagedObjects: %s.', count)
      };
    }
    ...
    function deleteEntity(id) {
      return api.deleteManagedObject(id, true);
    }
  }
})();
