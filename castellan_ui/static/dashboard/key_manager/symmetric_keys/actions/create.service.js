...
(function() {
  ...
  /**
   * @ngdoc overview
   * @name horizon.dashboard.key_manager.symmetric_keys.create.service
   * @description Service for the symmetric_key create modal
   */
  angular
    .module('horizon.dashboard.key_manager.symmetric_keys')
    .factory('horizon.dashboard.key_manager.symmetric_keys.create.service', createService);
  ...
  function createService(
    ...
    var message = {
      success: gettext('SymmetricKey %s was successfully created.')
    };
    ...
    function perform(selected, newScope) {
      ...
      title = gettext("Create SymmetricKey");
    ...
    function allowed() {
      ...
      //return policy.ifAllowed({ rules: [['symmetric_key', 'create_symmetric_key']] });
    }
