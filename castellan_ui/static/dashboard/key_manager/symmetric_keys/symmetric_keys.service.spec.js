...
(function() {
  ...
  describe('SymmetricKeys service', function() {
    var service;
    beforeEach(module('horizon.dashboard.key_manager.symmetric_keys'));
    beforeEach(inject(function($injector) {
      service = $injector.get('horizon.dashboard.key_manager.symmetric_keys.service');
    }));
    ...
    describe('getPromise', function() {
      it("provides a promise", inject(function($q, $injector, $timeout) {
        ...
        spyOn(api, 'getSymmetricKeys').and.returnValue(deferred.promise);
        ...
        $timeout.flush();
        expect(api.getSymmetricKeys).toHaveBeenCalled();
    ...
    describe('urlFunction', function() {
      it("get url", inject(function() {
        ...
        expect(result).toBe(detailRoute + "OS::KeyManager::SymmetricKey/123abc");
      }));
    });
