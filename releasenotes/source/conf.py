...
project = u'Castellan UI Release Notes'
...
repository_name = 'openstack/{cookiecutter.repo_name}}'
bug_project = 'castellan-ui'
bug_tag = ''
...
htmlhelp_basename = 'Castellan-UIReleaseNotesdoc'
...
latex_documents = [
    ('index',
     'Castellan-UIReleaseNotes.tex',
     u'Castellan UI Release Notes Documentation',
     u'Castellan UI Developers',
     'manual'),
]
